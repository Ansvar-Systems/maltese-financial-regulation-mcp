...
const TOOLS = [
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        sourcebook: { type: "string", description: "Filter by sourcebook ID (e.g., MFSA_Rules, MFSA_Guidance_Notes). Optional." },
        status: {
          type: "string",
  ...
  },
  {
    ...
    inputSchema: {
      type: "object" as const,
      properties: {
        sourcebook: { type: "string", description: "Sourcebook identifier (e.g., MFSA_Rules, MFSA_Guidance_Notes)" },
        reference: { type: "string", description: "Provision reference (e.g., MFSA_Rules ISL.1.2)" },
      },
  ...
  },
  {
    ...
    description: "List all MFSA sourcebooks with names and descriptions.",
  ...
  },
  {
    ...
    description: "Check whether a specific MFSA provision reference is currently in force.",
    inputSchema: {
      type: "object" as const,
      properties: {
