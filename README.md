# Maltese Financial Regulation MCP

**Maltese financial regulation data for AI compliance tools.**
...
**Endpoint:** `https://mcp.ansvar.eu/maltese-financial-regulation/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add maltese-financial-regulation-mcp --transport http https://mcp.ansvar.eu/maltese-financial-regulation/mcp` |
...
```json
{
  "mcpServers": {
    "maltese-financial-regulation-mcp": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/maltese-financial-regulation/mcp"
    }
  }
}
```
...
```bash
npx @ansvar/maltese-financial-regulation-mcp
```
...
```json
{
  "mcpServers": {
    "maltese-financial-regulation-mcp": {
      "command": "npx",
      "args": ["-y", "@ansvar/maltese-financial-regulation-mcp"]
    }
  }
}
```
...
| Tool | Description |
|------|-------------|
| `mt_fin_search_regulations` | Full-text search across MFSA Rules, Guidance Notes, and Circulars. Returns matching provisions from the Malta Financi... |
| `mt_fin_get_regulation` | Get a specific MFSA provision by sourcebook and reference. Accepts references like |
| `mt_fin_list_sourcebooks` | List all MFSA sourcebooks with their names and descriptions. |
| `mt_fin_search_enforcement` | Search MFSA enforcement actions — administrative penalties, licence withdrawals, and public warnings. Returns matchin... |
| `mt_fin_check_currency` | Check whether a specific MFSA provision reference is currently in force. Returns status and effective date. |
| `mt_fin_about` | Return metadata about this MCP server: version, data source, tool list. |
...
- **MFSA (Malta Financial Services Authority)** -- Official regulatory authority
...
>
> Regulatory data is sourced from official publications by MFSA (Malta Financial Services Authority). However:
...
```bash
git clone https://github.com/Ansvar-Systems/maltese-financial-regulation-mcp
cd maltese-financial-regulation-mcp
npm install
npm run build
npm test
```
